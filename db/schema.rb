...
ActiveRecord::Schema.define(version: 2020_01_19_154207) do
  ...
  create_table "user_admins", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["agrupamento_id"], name: "index_user_admins_on_agrupamento_id"
  ...
  add_foreign_key "user_admins", "agrupamentos"
